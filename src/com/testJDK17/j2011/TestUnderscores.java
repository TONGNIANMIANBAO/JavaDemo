...
public class TestUnderscores {
	...
	// float pi1 = 3_.1415F; // Invalid; cannot put underscores adjacent to a
	// decimal point
	...
	// int x6 = 0x_52; // Invalid; cannot put underscores at the beginning of a
	// number
